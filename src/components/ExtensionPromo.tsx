        ...
        <div className="container mx-auto px-4 py-12 md:py-16 flex flex-col md:flex-row items-center justify-between">
          <div className="text-white max-w-2xl mb-8 md:mb-0">
            ...
            <div className="flex flex-wrap gap-4">
              <Button className="bg-white text-outfit-blue hover:bg-blue-50 outfit-btn-primary">
                <ShoppingBag size={18} className="mr-2" /> 
                Get the Extension
              </Button>
              <Button variant="outline" className="border-white text-white hover:bg-white/10 outfit-btn-outline">
              ...
              <div className="bg-gray-100 p-2 rounded-lg">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="w-1/2 flex flex-col justify-center items-center">
                    <div className="text-outfit-blue mb-2">
                      <ShoppingBag size={24} />
                    </div>
